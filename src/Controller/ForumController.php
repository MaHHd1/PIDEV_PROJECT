...
class ForumController extends AbstractController
{
    ...
    public function delete(ForumDiscussion $forum, EntityManagerInterface $em): Response
    {
        if (!$this->authChecker->isLoggedIn()) {
            return $this->redirectToRoute('app_login');
        }
    ...
    public function adminForums(
        ...
        // Commentaires groupés par forum pour les modals
    ...
    #[Route('/admin/forums/{id}/delete', name: 'admin_forum_delete', methods: ['POST'])]
    public function adminDeleteForum(ForumDiscussion $forum, EntityManagerInterface $em): Response
    {
        if (!$this->authChecker->isLoggedIn()) {
            return $this->redirectToRoute('app_login');
        }
