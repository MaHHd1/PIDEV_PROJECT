...
class CommentaireForum
{
    ...
    #[ORM\JoinColumn(name: 'id_forum_id', referencedColumnName: 'id_forum', nullable: false, onDelete: 'CASCADE')]
    private ?ForumDiscussion $forum = null;

    #[ORM\ManyToOne(targetEntity: Utilisateur::class)]
    #[ORM\JoinColumn(name: 'id_utilisateur_id', referencedColumnName: 'id', nullable: false)]
    ...
    #[ORM\JoinColumn(name: 'id_parent_id', referencedColumnName: 'id_commentaire', nullable: true, onDelete: 'SET NULL')]
    ...
    public function setDateModification(?\DateTimeImmutable $d): self { $this->dateModification = $d; return $this; }
