...
class MessageRepository extends ServiceEntityRepository
{
    ...
    /* =========================
       INBOX
    ========================== */
    public function paginateInbox(User $user, ?string $q, int $page, int $limit = 10): array
    {
    ...
    /* =========================
       SENT
    ========================== */
    public function paginateSent(User $user, ?string $q, int $page, int $limit = 10): array
    {
    ...
    /* =========================
       ARCHIVE
    ========================== */
    public function paginateArchive(User $user, ?string $q, int $page, int $limit = 10): array
    {
    ...
    ========================== */
    private function paginateBase(string $mode, User $user, ?string $q, int $page, int $limit): array
    {
        $page = max(1, $page);
