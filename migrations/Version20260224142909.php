 ...
 */
final class Version20260224142909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation ADD pdf_filename VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, ADD cours_id INT NOT NULL, DROP id_cours');
